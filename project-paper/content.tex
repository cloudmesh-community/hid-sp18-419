...
\TODO{Please add content to this paragraph}
...
\TODO{Please check if this paragraph is appropriate}
...
contents, \verb|~/.ssh| and its
contents: \verb|id_rsa|, \verb|id_rsa.pub|, and \verb|authorized_keys|
are owned by root. This leads to a permissions error when connecting
via ssh from one pi to another. Solutions for this issue need to be
investigated.
