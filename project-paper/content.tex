...
result~\cite{hid-sp18-405-dean2008mapreduce}. As illustrated in
Figure~\ref{f:hadoop-high}, the Master Node will have a JobTracker
that distributes MapReduce tasks to nodes in the cluster. The
TaskTracker within each node is monitored by the Jobtracker. In case
of a failure reported by a TaskTracker, the Jobtracker may reassign
work to some of the other nodes~\cite{hid-sp18-405-hadoop-jobtracker}.
...
into \verv|hadoop-streaming.jar| as parameters to create and run
