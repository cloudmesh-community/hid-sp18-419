\section{OpenDaylight}\index{OpenDaylight}\index{SDN}\index{NFV}\index{Cisco}\index{Citrix}\index{Ericsson}\index{HP}\index{IBM}\index{Microsoft}\index{NEC}\index{Red Hat}\index{VMWare}

OpenDaylight is an open source Software Defined Network
(SDN)\index{SDN} controller\cite{hid-sp18-419-www-opendaylight}. SDN
...
Cisco\index{Cisco}, Citrix\index{Citrix}, Ericsson\index{Ericsson},
HP\index{HP}, IBM\index{IBM}, Microsoft\index{Microsoft},
NEC\index{NEC}, Red Hat\index{Red Hat}, and
VMware\index{VMWare}. Microsoft and VMware have since left the
