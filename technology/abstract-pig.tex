...
Pig is a part of the Apache \index{Apache}Hadoop
\index{Hadoop}ecosystem consisting of a scripting language called Pig
Latin \index{Pig Latin}and a compiler that produces Map-Reduce
\index{Map-Reduce}programs. It was initially developed in 2006 at
Yahoo! \index{Yahoo\!}and taken over by Apache in 2007
...
between Pig and Hive \index{Hive}, an SQL-like \index{SQL} language
